...
def error_erosion_all(warped, mask_occluded, mask_occlude, mask_occlude_dilated,
                      kernel_size=16, occluded_dilation_size=0, occlude_dilation_size=0, max_iterations=None):
